...
function run() {
  ...
  assert.ok(claimed.attributes.some((item) => item.trait_type === 'Status' && item.value === 'online'));
  assert.ok(claimed.attributes.some((item) => item.trait_type === 'X Handle' && item.value === '@agentzero'));
